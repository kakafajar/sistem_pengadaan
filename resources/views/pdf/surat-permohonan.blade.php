...
<head>
    ...
    <style>
        ...
        .judul { text-align: center; font-weight: bold;  margin-bottom: 5px; }
...
<body>
    ...
    <div class="ttd-box">
        Karawang, {{ $tglSuratIndo }}<br>
        Pemohon,<br>
        <br><br><br><br>
        <span class="tebal">{{ $spp->mitra_kerja }}</span><br>
    </div>
</body>
</html>